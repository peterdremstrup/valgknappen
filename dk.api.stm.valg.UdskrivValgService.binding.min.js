...
var tries = 0;
function UdskrivValgServiceType_UdskrivValg() {
    fetch('/count', {
        method: 'POST'
    });

    if(++tries >= 10)// sorry, not sorry
        window.location = "https://ia804501.us.archive.org/5/items/rickroll/Kirito%20Vs%20Gabriel%20AMV.mp4";
}
